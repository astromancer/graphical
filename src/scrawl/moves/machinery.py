...
class CanvasBlitHelper(CallbackManager):
    def __init__(self, artists=(), connect=False, active=True):
        ...
        # connect
        CallbackManager.__init__(self, self.canvas, connect and self.use_blit)
    ...
    def blit_setup(self, artists=None):
        ...
        artists will be used. Passing an empty list of artists to redraw and
        save the canvas including all vissible art.
        """
